...
|---|---|---|---|---|
| REQ-001 | (example — replace) Device pairing completes in under 5 s on the target network | .github/docs/context/device-pairing/interview-2026-07-01.md | timed integration test in `pairing.spec` | example |
